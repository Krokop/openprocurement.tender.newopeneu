...
@opresource(name='Tender NewEU',
            path='/tenders/{tender_id}',
            procurementMethodType='newOpenEU',
            description="New openEU")
class TenderNewEUResource(TenderResource):
    """ Resource handler for New TenderEU """
    ...
    def patch(self):
        ...
        if self.request.authenticated_role == 'chronograph':
            ...
            if all_bids_are_reviewed(self.request):
                ...
                tender.qualificationPeriod.endDate = calculate_business_date(normalized_date, COMPLAINT_STAND_STILL,
